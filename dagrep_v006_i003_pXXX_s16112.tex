...
\abstractauthor[Philipp Haselwarter]{Philipp Haselwarter (University of Ljubljana, SI)}
\license
\jointwork{Andrej Bauer, Gaëtan Gilbert, Matija Pretnar, Christopher A. Stone}
\abstractref[https://github.com/Andromedans/andromeda/releases/tag/dagstuhl-2016]{http://andromedans.github.io/andromeda/}
...
The effect information of \verb|perform E1|
...
\end{verbatim}
%
to have the type $A ! \{ \chooseop \} \& \eqs \hto A ! \{ \chooseop \} \& \eqs$
for any set of equations ${\eqs \subseteq \{ \assoc, \comm, \idem \}}$.

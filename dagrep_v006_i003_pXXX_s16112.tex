...
is the type of natural numbers (we ignore nagative values).
...
%
\begin{quote}
  \emph{Identify comptuational effects which allow realization of the modulus of
    continuity, and prove \emph{rigorously} prove that it works.}
\end{quote}
%
Attacking the problem ought to improve our ability to argue about higher-type computation
in the presenence of computational effects.
